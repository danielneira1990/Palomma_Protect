...
export default async function InmobiliariasPage() {
  ...
  if (!supabase) {
    ...
    const { data, error: e } = await supabase
      .from("inmobiliaria")
      .select(
        "id, codigo, razon_social, nit, sucursal, ciudad, estado, sagrilaft_estado, num_contrato_marco, persona_contacto, email_contacto, telefono, created_at, bienvenida_enviada_at",
      )
